...
## 📃INTRODUCCIÓN
Este repositorio de GitHub es un ejemplo de un XML sobre el catálogo de Netflix. Contiene información de varias películas, series y documentales de forma organizada.
